...
<div class="navbar bg-base-100">
  <div class="navbar-start">
    <div class="dropdown">
      ...
      >
        {#if $profile}
          <li><a href="https://weavedownloader.vercel.app/">Create your dataset</a></li>
      ...
      <a href="/" class="btn btn-ghost normal-case text-sm md:hidden"
        >DaaSWeave Atomic Asset Creator</a
      >
    </div>
  </div>
  ...
  <div class="hidden navbar-end md:flex">
    {#if $profile}
      ...
      <a href="https://weavedownloader.vercel.app/" class="btn btn-ghost">Create your dataset</a>
