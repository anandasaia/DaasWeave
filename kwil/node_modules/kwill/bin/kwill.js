(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("Kwill", [], factory);
	else if(typeof exports === 'object')
		exports["Kwill"] = factory();
	else
		root["Kwill"] = factory();
})(this, function() {
...
exports.activeID = new Subject_1.Subject();
exports.observableHue = new BehaviorSubject_1.BehaviorSubject(0);
exports.observableSaturation = new BehaviorSubject_1.BehaviorSubject(0);
exports.observableLightness = new BehaviorSubject_1.BehaviorSubject(0);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.KWILL_CONSTS = {
    elements: {
        selectors: {
            text_pane: 'kwill-text-pane'
        }
    },
    events: {
        ...
        SHOW_TEXT_FORMAT_POPUP: 'show text format popup',
        HIDE_TEXT_FORMAT_POPUP: 'hide text format popup'
    },
    textFormats: {
        BOLD: 'bold',
        ITALIC: 'italic',
...
var Interaction_1 = __webpack_require__(57);
var ValidateOptions_1 = __webpack_require__(22);
...
function findOne(selector) {
    ...
    if (isSelectorElement(selector)) return selector;
 ...
 * @param selector
 */
function isSelectorElement(selector) {
    try {
        var window = void 0;
        //  get the window owner for this element
        window = selector.ownerDocument.defaultView;
 ...
 * @return {any}
 */
function findByRoleWithin(selector, role) {
    try {
        return findOne(selector).querySelector('[data-role="' + role + '"]');
    } catch (e) {
        console.warn('no element found');
        return null;
    }
}
exports.findByRoleWithin = findByRoleWithin;
/**
 ...
 * @return {any}
 */
function findByRolesWithin(selector, role) {
    try {
        return findOne(selector).querySelectorAll('[data-role="' + role + '"]');
    } catch (e) {
        return null;
    }
}
exports.findByRolesWithin = findByRolesWithin;
...
function getGlobalSignal(signalID) {
    return getInstances()[signalID] || createSignal(signalID);
}
exports.getGlobalSignal = getGlobalSignal;
function createSignal(signalID) {
    return getInstances()[signalID] = new signals_1.Signal();
}
function getInstances() {
    return instances || (instances = {});
}
function destroyAllGlobalSignals() {
    lodash_1.forIn(instances, function (signal, id) {
        return signal.dispose();
    });
    instances = null;
}
exports.destroyAllGlobalSignals = destroyAllGlobalSignals;
...
Object.defineProperty(exports, "__esModule", { value: true });
var tinycolor = __webpack_require__(139);
var Observables_1 = __webpack_require__(1);
var Subject_1 = __webpack_require__(17);
...
var isPromise_1 = __webpack_require__(136);
var isObject_1 = __webpack_require__(49);
...
Object.defineProperty(exports, "__esModule", { value: true });
var RemoveAttributes_1 = __webpack_require__(79);
var GetNodesInRange_1 = __webpack_require__(36);
function styleSelection(styleName, value) {
    document.execCommand('fontSize', false, 4);
    RemoveAttributes_1.removeAttributes(GetNodesInRange_1.getNodesInRange(), 'size').map(function (node) {
        return node.style.setProperty(styleName, value);
    });
}
exports.styleSelection = styleSelection;
function styleGroup(styleName, value) {
    GetNodesInRange_1.getBlockLevelNodesInRange().map(function (node) {
        return node.style.setProperty(styleName, value);
    });
}
...
function hasUnits(value) {
    return !!value.match(/px|em|rem|%/);
}
exports.hasUnits = hasUnits;
function stripUnits(value) {
    return parseFloat(value).toString();
}
exports.stripUnits = stripUnits;
...
var lodash_1 = __webpack_require__(3);
var Constants_1 = __webpack_require__(2);
var GlobalEvents_1 = __webpack_require__(6);
var TextEditor_1 = __webpack_require__(4);
...
function trackEdits(instanceID) {
    ...
    contentChangeDelay = window.setTimeout(function () {
        return GlobalEvents_1.getGlobalSignal(Constants_1.KWILL_CONSTS.events.EDIT_PROGRESS).dispatch(getInstanceState(instanceID));
    }, 1000);
}
    ...
    lodash_1.forIn(getContentStateDictionary(), function (instanceState, instanceID) {
        try {
            if (instanceState.contentHasChanged === true) {
                ...
                GlobalEvents_1.getGlobalSignal(Constants_1.KWILL_CONSTS.events.EDIT_COMPLETE).dispatch(instanceState);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Logging_1 = __webpack_require__(72);
var GlobalInteractions_1 = __webpack_require__(32);
var isSetup;
function oneTimeSetup(options) {
    if (isSetup) return;
    Logging_1.getLogger().setLevel(getLogLevel(options));
    GlobalInteractions_1.addGlobalListeners();
    isSetup = true;
}
exports.oneTimeSetup = oneTimeSetup;
function getLogLevel(options) {
    try {
        return options.config.debug === true ? 0 : 5;
    } catch (e) {
        return 5;
    }
}
function destroyOneTimeSetup() {
    GlobalInteractions_1.removeGlobalListeners();
    isSetup = false;
}
exports.destroyOneTimeSetup = destroyOneTimeSetup;
...
Object.defineProperty(exports, "__esModule", { value: true });
var TextEditor_1 = __webpack_require__(4);
function getEditorOptions(instanceID) {
    return TextEditor_1.getTextEditor(instanceID).options;
}
exports.getEditorOptions = getEditorOptions;
function getEditorElement(instanceID) {
    return TextEditor_1.getTextEditor(instanceID).element;
}
exports.getEditorElement = getEditorElement;
function getTextEditorContent(instanceID) {
    var editorInstance = TextEditor_1.getTextEditor(instanceID);
    if (editorInstance) return editorInstance.content;
}
exports.getTextEditorContent = getTextEditorContent;
function setTextEditorContent(instanceID, content) {
    var editorInstance = TextEditor_1.getTextEditor(instanceID);
    if (editorInstance) editorInstance.content = content;
}
exports.setTextEditorContent = setTextEditorContent;
...
var lodash_1 = __webpack_require__(3);
var Find_1 = __webpack_require__(16);
var FrameUtils_1 = __webpack_require__(33);
var FormatInteractions_1 = __webpack_require__(35);
var UpdateState_1 = __webpack_require__(75);
var Constants_1 = __webpack_require__(2);
var GlobalEvents_1 = __webpack_require__(6);
var ColourPicker_1 = __webpack_require__(76);
...
var TextFormatUiBase = function () {
    ...
    _createClass(TextFormatUiBase, [{
        ...
        value: function addListeners() {
            ...
            GlobalEvents_1.getGlobalSignal(Constants_1.KWILL_CONSTS.events.TEXT_FORMAT).add(function (textFormat) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var Constants_1 = __webpack_require__(2);
var FontColour_1 = __webpack_require__(61);
var LetterSpacing_1 = __webpack_require__(65);
var LineHeight_1 = __webpack_require__(66);
var FontSize_1 = __webpack_require__(63);
var FontFamily_1 = __webpack_require__(62);
var TextAlign_1 = __webpack_require__(68);
var Strikethrough_1 = __webpack_require__(67);
var AddLink_1 = __webpack_require__(70);
var Bold_1 = __webpack_require__(59);
var Italic_1 = __webpack_require__(64);
var Underline_1 = __webpack_require__(69);
var ClearStyles_1 = __webpack_require__(60);
function formatText(format, value) {
    window.focus();
    switch (format) {
        case Constants_1.KWILL_CONSTS.textFormats.BOLD:
            return Bold_1.toggleBold();
        case Constants_1.KWILL_CONSTS.textFormats.ITALIC:
            return Italic_1.toggleItalic();
        case Constants_1.KWILL_CONSTS.textFormats.UNDERLINE:
            return Underline_1.toggleUnderline();
        case Constants_1.KWILL_CONSTS.textFormats.STRIKETHROUGH:
            return Strikethrough_1.toggleStrikethrough();
        case Constants_1.KWILL_CONSTS.textFormats.TEXT_ALIGN:
            return TextAlign_1.setTextAlign(value);
        case Constants_1.KWILL_CONSTS.textFormats.FONT_FAMILY:
            return FontFamily_1.setFontFamily(value);
        case Constants_1.KWILL_CONSTS.textFormats.FONT_SIZE:
            return FontSize_1.setFontSize(value);
        case Constants_1.KWILL_CONSTS.textFormats.LINE_HEIGHT:
            return LineHeight_1.setLineHeight(value);
        case Constants_1.KWILL_CONSTS.textFormats.LETTER_SPACING:
            return LetterSpacing_1.setLetterSpacing(value);
        case Constants_1.KWILL_CONSTS.textFormats.TEXT_COLOUR:
            return FontColour_1.setTextColour(value);
        case Constants_1.KWILL_CONSTS.textFormats.BACKGROUND_COLOUR:
            return FontColour_1.setBackgroundColour(value);
        case Constants_1.KWILL_CONSTS.textFormats.LINK:
            return AddLink_1.setLink(value);
        case Constants_1.KWILL_CONSTS.textFormats.CLEAR_STYLE:
            return ClearStyles_1.clearStyles();
    }
}
...
Object.defineProperty(exports, "__esModule", { value: true });
var GlobalEvents_1 = __webpack_require__(6);
var Selections_1 = __webpack_require__(73);
var TrackChanges_1 = __webpack_require__(20);
var Constants_1 = __webpack_require__(2);
function addGlobalListeners() {
    document.addEventListener('mousedown', onDocumentMouseDown);
    document.addEventListener('mouseup', onDocumentMouseUp);
    document.addEventListener('scroll', onDocumentScroll);
    GlobalEvents_1.getGlobalSignal(Constants_1.KWILL_CONSTS.events.CLEAR_SELECTION).add(Selections_1.clearSelection);
}
exports.addGlobalListeners = addGlobalListeners;
var onDocumentMouseDown = function onDocumentMouseDown(mouseEvent) {
    GlobalEvents_1.getGlobalSignal(Constants_1.KWILL_CONSTS.events.HIDE_TEXT_FORMAT_POPUP).dispatch();
};
var onDocumentMouseUp = function onDocumentMouseUp(mouseEvent) {
    TrackChanges_1.stopTrackingEdits();
};
var onDocumentScroll = function onDocumentScroll(mouseEvent) {
    GlobalEvents_1.getGlobalSignal(Constants_1.KWILL_CONSTS.events.HIDE_TEXT_FORMAT_POPUP).dispatch();
};
...
exports.removeGlobalListeners = removeGlobalListeners;
...
Object.defineProperty(exports, "__esModule", { value: true });
var lodash_1 = __webpack_require__(3);
var FontLoader_1 = __webpack_require__(80);
...
var Find_1 = __webpack_require__(16);
var FrameUtils_1 = __webpack_require__(33);
var TextFormatPopup_1 = __webpack_require__(77);
var instances = void 0;
...
Object.defineProperty(exports, "__esModule", { value: true });
var lodash_1 = __webpack_require__(3);
var FormatText_1 = __webpack_require__(31);
var Constants_1 = __webpack_require__(2);
var GlobalEvents_1 = __webpack_require__(6);
var FormatSniffer_1 = __webpack_require__(18);
var TextEditor_1 = __webpack_require__(4);
var TrackChanges_1 = __webpack_require__(20);
...
exports.onFormatUiInteraction = function (event) {
    ...
    GlobalEvents_1.getGlobalSignal(Constants_1.KWILL_CONSTS.events.TEXT_FORMAT).dispatch(FormatSniffer_1.sniffFormats());
...
Object.defineProperty(exports, "__esModule", { value: true });
var log = __webpack_require__(10);
var Dictionary_1 = __webpack_require__(82);
var ColourPicker_1 = __webpack_require__(81);
var Observables_1 = __webpack_require__(1);
var Options_1 = __webpack_require__(96);
/**
 ...
 */
function allowSelections() {
    var allowSelections = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;

    var styles = void 0,
        value = void 0;
    //  create a list of all the non-editable styles
    styles = ['-webkit-touch-callout', '-webkit-user-select', '-khtml-user-select', '-moz-user-select', '-ms-user-select', 'user-select'];
    //  get the value we want to set
    value = allowSelections === true ? null : 'none';
    //  add or remove all styles
    styles.map(function (style) {
        return document.body.style.setProperty(style, value);
    });
}
exports.allowSelections = allowSelections;
...
var Observable_1 = __webpack_require__(0);
var take_1 = __webpack_require__(125);
...
var mergeAll_1 = __webpack_require__(124);
...
Object.defineProperty(exports, "__esModule", { value: true });
var ValidateOptions_1 = __webpack_require__(22);
var OneTimeSetup_1 = __webpack_require__(21);
var TextEditor_1 = __webpack_require__(4);
function createKwillEditor(options) {
    if (!ValidateOptions_1.areOptionsValid(options)) return;
    OneTimeSetup_1.oneTimeSetup(options);
    ValidateOptions_1.populateDefaultEditorOptions(options);
    return TextEditor_1.createTextEditor(options.id, options);
}
exports.createKwillEditor = createKwillEditor;
...
var GlobalEvents_1 = __webpack_require__(6);
var TextEditor_1 = __webpack_require__(4);
var TextFormatUi_1 = __webpack_require__(34);
var OneTimeSetup_1 = __webpack_require__(21);
function destroyAllKwillInstances(forever) {
    GlobalInteractions_1.removeGlobalListeners();
    GlobalEvents_1.destroyAllGlobalSignals();
    TextEditor_1.destroyAllTextEditors();
    TextFormatUi_1.destroyAllTextFormatUi();
    OneTimeSetup_1.destroyOneTimeSetup();
}
exports.destroyAllKwillInstances = destroyAllKwillInstances;
...
var OneTimeSetup_1 = __webpack_require__(21);
var TextFormatUi_1 = __webpack_require__(34);
function createKwillTextFormatUi(options) {
    OneTimeSetup_1.oneTimeSetup(options);
    ValidateOptions_1.populateDefaultFormatUiOptions(options);
    return TextFormatUi_1.createTextFormatUi(options);
}
exports.createKwillTextFormatUi = createKwillTextFormatUi;
...
Object.defineProperty(exports, "__esModule", { value: true });
var EditorInstanceUtils_1 = __webpack_require__(29);
var GlobalEvents_1 = __webpack_require__(6);
var PreventContentDeletion_1 = __webpack_require__(71);
var SignalBindingsManager_1 = __webpack_require__(58);
var TrackChanges_1 = __webpack_require__(20);
var Constants_1 = __webpack_require__(2);
var TextEditor_1 = __webpack_require__(4);
...
var onSelectionEnd = function onSelectionEnd(mouseEvent) {
    ...
    setTimeout(function () {
        ...
        GlobalEvents_1.getGlobalSignal(Constants_1.KWILL_CONSTS.events.SHOW_TEXT_FORMAT_POPUP).dispatch(mouseEvent);
    }, 10);
};
...
Object.defineProperty(exports, "__esModule", { value: true });
var instances;
function saveSignalBinding(binding, instanceID) {
    getInstanceBindings(instanceID).push(binding);
}
exports.saveSignalBinding = saveSignalBinding;
function clearSignalBindings(instanceID) {
    getInstanceBindings(instanceID).map(function (binding) {
        return binding.detach();
    });
}
exports.clearSignalBindings = clearSignalBindings;
function getInstanceBindings(instanceID) {
...
function clearStyles() {
    var activeParagraph = void 0;
    activeParagraph = TextEditor_1.getActiveTextEditor().getActiveParagraph();
    activeParagraph.innerHTML = activeParagraph.textContent;
    activeParagraph.removeAttribute('style');
}
...
Object.defineProperty(exports, "__esModule", { value: true });
function setTextColour(fontColour) {
...
function setBackgroundColour(backgroundColour) {
    document.execCommand('backColor', false, backgroundColour);
}
exports.setBackgroundColour = setBackgroundColour;
function extractFontColour(input) {
...
exports.extractFontColour = extractFontColour;
...
function extractFontFamily(input) {
    switch (typeof input === "undefined" ? "undefined" : _typeof(input)) {
        case 'string':
            return input;
        case 'object':
...
Object.defineProperty(exports, "__esModule", { value: true });
var SetStyle_1 = __webpack_require__(15);
var FormatSniffer_1 = __webpack_require__(18);
var Constants_1 = __webpack_require__(2);
...
var SetStyle_1 = __webpack_require__(15);
var Constants_1 = __webpack_require__(2);
var UnitsUtils_1 = __webpack_require__(19);
function setLetterSpacing(letterSpacing) {
    SetStyle_1.styleGroup(Constants_1.KWILL_CONSTS.textFormats.LETTER_SPACING, parseLetterSpacing(letterSpacing));
}
exports.setLetterSpacing = setLetterSpacing;
function parseLetterSpacing(letterSpacing) {
    if (UnitsUtils_1.hasUnits(letterSpacing)) return letterSpacing;
    return parseFloat(letterSpacing) + 'px';
}
...
function setLineHeight(lineHeight) {
    SetStyle_1.styleGroup(Constants_1.KWILL_CONSTS.textFormats.LINE_HEIGHT, lineHeight);
}
exports.setLineHeight = setLineHeight;
function parseLineHeight(lineHeight) {
    if (UnitsUtils_1.hasUnits(lineHeight)) return lineHeight;
    return parseFloat(lineHeight) + 'px';
}
...
function setTextAlign(textAlign) {
    SetStyle_1.styleGroup('text-align', textAlign);
}
...
function setLink(url) {
    url ? document.execCommand('createLink', false, url) : document.execCommand('unlink');
}
...
Object.defineProperty(exports, "__esModule", { value: true });
var TextEditor_1 = __webpack_require__(4);
function stopUserDeletingEditableElement(id, event) {
    var keyCode = void 0;
    keyCode = event.keyCode;
    if (keyCode !== 8 && keyCode !== 46) return;
    if (editableElementIsEmpty(id)) event.preventDefault();
}
exports.stopUserDeletingEditableElement = stopUserDeletingEditableElement;
function editableElementIsEmpty(id) {
    return TextEditor_1.getTextEditor(id).element.textContent === '';
}
...
Object.defineProperty(exports, "__esModule", { value: true });
var Constants_1 = __webpack_require__(2);
exports.KWILL_CONSTS = Constants_1.KWILL_CONSTS;
var FontList_1 = __webpack_require__(55);
exports.getAllFonts = FontList_1.getAllFonts;
var GlobalEvents_1 = __webpack_require__(6);
exports.getGlobalSignal = GlobalEvents_1.getGlobalSignal;
var EditorInstanceUtils_1 = __webpack_require__(29);
exports.getTextEditorContent = EditorInstanceUtils_1.getTextEditorContent;
exports.setTextEditorContent = EditorInstanceUtils_1.setTextEditorContent;
var TextFormatUiBase_1 = __webpack_require__(30);
exports.TextFormatUiBase = TextFormatUiBase_1.TextFormatUiBase;
var TextEditor_1 = __webpack_require__(4);
exports.destroyTextEditor = TextEditor_1.destroyTextEditor;
var destroyAllInstances_1 = __webpack_require__(54);
exports.destroyAllKwillInstances = destroyAllInstances_1.destroyAllKwillInstances;
...
var Constants_1 = __webpack_require__(2);
var FormatText_1 = __webpack_require__(31);
var kulr_1 = __webpack_require__(37);
...
var TextFormatUiBase_1 = __webpack_require__(30);
var kulr_1 = __webpack_require__(37);
var Offset_1 = __webpack_require__(78);
...
var TextFormatPopup = function (_TextFormatUiBase_1$T) {
    ...
    _createClass(TextFormatPopup, [{
        ...
        value: function addListeners() {
            ...
            GlobalEvents_1.getGlobalSignal(Constants_1.KWILL_CONSTS.events.SHOW_TEXT_FORMAT_POPUP).add(function (event) {
                return showTextFormatPopup(_this2.frame, event);
            });
            GlobalEvents_1.getGlobalSignal(Constants_1.KWILL_CONSTS.events.HIDE_TEXT_FORMAT_POPUP).add(function () {
                return hideTextFormatPopup(_this2.frame);
            });
            GlobalEvents_1.getGlobalSignal(Constants_1.KWILL_CONSTS.events.TEXT_FORMAT).add(function () {
...
Object.defineProperty(exports, "__esModule", { value: true });
function removeAttributes(nodes, attribute) {
    var result = void 0;
    result = nodes.filter(function (node) {
        return hasAttribute(node, attribute);
    });
...
Object.defineProperty(exports, "__esModule", { value: true });
var lodash_1 = __webpack_require__(3);
var WebFont = __webpack_require__(140);
function loadFontsForFrame(frame, options) {
    var config = {
        google: {
            families: lodash_1.get(options, 'fonts.google'),
            text: lodash_1.get(options, 'fonts.glyphs')
        },
        context: frame.contentWindow
    };
    WebFont.load(config);
}
exports.loadFontsForFrame = loadFontsForFrame;
...
Object.defineProperty(exports, "__esModule", { value: true });
var BasicColourPicker_1 = __webpack_require__(83);
var Observables_1 = __webpack_require__(1);
var ColourMixer_1 = __webpack_require__(9);
var Observable_1 = __webpack_require__(0);
 ...
 * @param instanceID
 */
function saveInstance(instance, instanceID) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var TonePane_1 = __webpack_require__(92);
var HuePane_1 = __webpack_require__(87);
var Find_1 = __webpack_require__(5);
var HexField_1 = __webpack_require__(84);
var ColourSwatch_1 = __webpack_require__(95);
var Observables_1 = __webpack_require__(1);
var Toggle_1 = __webpack_require__(89);
var Constants_1 = __webpack_require__(7);
var Confirm_1 = __webpack_require__(94);
var Cancel_1 = __webpack_require__(93);
/**
 * create a basic colour picker
 * @param options
 */
...
Object.defineProperty(exports, "__esModule", { value: true });
var Observables_1 = __webpack_require__(1);
var Interactions_1 = __webpack_require__(85);
var ColourMixer_1 = __webpack_require__(9);
var Validator_1 = __webpack_require__(97);
var Constants_1 = __webpack_require__(7);
var Find_1 = __webpack_require__(5);
/**
...
exports.onHexFieldInput = onHexFieldInput;
/**
 * @param event
 */
function onHexFieldBlur(event) {}
exports.onHexFieldBlur = onHexFieldBlur;
...
Object.defineProperty(exports, "__esModule", { value: true });
var SvgUtils_1 = __webpack_require__(38);
var UniqueId_1 = __webpack_require__(24);
var Constants_1 = __webpack_require__(7);
var Find_1 = __webpack_require__(5);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var Observables_1 = __webpack_require__(1);
var Elements_1 = __webpack_require__(86);
var Interactions_1 = __webpack_require__(88);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var Clamp_1 = __webpack_require__(40);
var Observables_1 = __webpack_require__(1);
var PreventSelections_1 = __webpack_require__(39);
var huePane = void 0;
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var Elements_1 = __webpack_require__(90);
var Observables_1 = __webpack_require__(1);
var Interactions_1 = __webpack_require__(91);
/**
...
var Observable_1 = __webpack_require__(0);
var buffer_1 = __webpack_require__(119);
...
var Observable_1 = __webpack_require__(0);
var debounce_1 = __webpack_require__(121);
...
var Observable_1 = __webpack_require__(0);
var delay_1 = __webpack_require__(122);
...
var Observable_1 = __webpack_require__(0);
var takeUntil_1 = __webpack_require__(126);
...
var Subscriber_1 = __webpack_require__(8);
var ArgumentOutOfRangeError_1 = __webpack_require__(131);
var EmptyObservable_1 = __webpack_require__(44);
/**
