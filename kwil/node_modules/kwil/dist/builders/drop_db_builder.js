...
class DropDBBuilderImpl {
    ...
    static of(client) {
        return new DropDBBuilderImpl(objects_1.objects.requireNonNil(client));
    }
    signer(signer) {
    ...
    buildTx() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return transaction_builder_1.TxnBuilderImpl
                .of(this.client)
                .payloadType(tx_1.PayloadType.DROP_DATABASE)
...
exports.DropDBBuilderImpl = DropDBBuilderImpl;
//# sourceMappingURL=drop_db_builder.js.map